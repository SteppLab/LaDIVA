...
%   end
  ...
  N=Ix-Q*DY'*pinv(JJ+LAMBDA*EPS^2*Iy)*DY*Q'; % computes null space projector

  block.OutputPort(1).Data = K*N*x;
  
  %block.OutputPort(1).Data(11,1) =1; % set f0 null space to 0.1 activation level CT
  %block.OutputPort(1).Data(12,1) =1; % set SPL null space to 0.1 activation level TA
  %block.OutputPort(1).Data(13,1) =1; % set SPL null space to 800 Pa Ps
  %block.OutputPort(1).Data(14,1) =1; % set SPL null space to 800 Pa Ps
end
